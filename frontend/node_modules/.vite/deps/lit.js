  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_b6 = this.__controllers) === null || _b6 === void 0 ? void 0 : _b6.forEach((c) => {
          var _a7;
...
function resolveDirective(part, value, parent = part, attributeIndex) {
  ...
  if ((currentDirective === null || currentDirective === void 0 ? void 0 : currentDirective.constructor) !== nextDirectiveConstructor) {
    ...
    if (attributeIndex !== void 0) {
      ((_c6 = (_d5 = parent).__directives) !== null && _c6 !== void 0 ? _c6 : _d5.__directives = [])[attributeIndex] = currentDirective;
    } else {
...
var ChildPart = class _ChildPart {
  ...
  get _$isConnected() {
    var _a6, _b6;
    return (_b6 = (_a6 = this._$parent) === null || _a6 === void 0 ? void 0 : _a6._$isConnected) !== null && _b6 !== void 0 ? _b6 : this.__isConnected;
  }
  /**
...
var EventPart = class extends AttributePart {
  ...
  handleEvent(event) {
    ...
    if (typeof this._$committedValue === "function") {
      this._$committedValue.call((_b6 = (_a6 = this.options) === null || _a6 === void 0 ? void 0 : _a6.host) !== null && _b6 !== void 0 ? _b6 : this.element, event);
    } else {
...
if (NODE_MODE5) {
  (_a3 = global5.customElements) !== null && _a3 !== void 0 ? _a3 : global5.customElements = customElements;
}
var DEV_MODE3 = true;
...
if (DEV_MODE3) {
  const issuedWarnings = (_b3 = global5.litIssuedWarnings) !== null && _b3 !== void 0 ? _b3 : global5.litIssuedWarnings = /* @__PURE__ */ new Set();
  ...
  if (((_c3 = global5.ShadyDOM) === null || _c3 === void 0 ? void 0 : _c3.inUse) && polyfillSupport3 === void 0) {
...
var ReactiveElement2 = class extends HTMLElement {
  ...
  __propertyToAttribute(name, value, options = defaultPropertyDeclaration2) {
    ...
    const attr = this.constructor.__attributeNameForProperty(name, options);
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a6 = options.converter) === null || _a6 === void 0 ? void 0 : _a6.toAttribute) !== void 0 ? options.converter : defaultConverter2;
      const attrValue = converter.toAttribute(value, options.type);
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      const options = ctor.getPropertyOptions(propName);
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a6 = options.converter) === null || _a6 === void 0 ? void 0 : _a6.fromAttribute) !== void 0 ? options.converter : defaultConverter2;
      this.__reflectingProperty = propName;
      this[propName] = converter.fromAttribute(
        value,
        options.type
  ...
  performUpdate() {
    ...
    debugLogEvent3 === null || debugLogEvent3 === void 0 ? void 0 : debugLogEvent3({ kind: "update" });
    if (!this.hasUpdated) {
      if (DEV_MODE3) {
        const shadowedProperties = [];
        (_a6 = this.constructor.__reactivePropertyKeys) === null || _a6 === void 0 ? void 0 : _a6.forEach((p) => {
...
((_d3 = global5.reactiveElementVersions) !== null && _d3 !== void 0 ? _d3 : global5.reactiveElementVersions = []).push("1.6.3");
...
var global6 = NODE_MODE6 ? globalThis : window;
...
var issueWarning4;
if (DEV_MODE4) {
  (_a4 = global6.litIssuedWarnings) !== null && _a4 !== void 0 ? _a4 : global6.litIssuedWarnings = /* @__PURE__ */ new Set();
...
var wrap2 = ENABLE_SHADYDOM_NOPATCH2 && ((_b4 = global6.ShadyDOM) === null || _b4 === void 0 ? void 0 : _b4.inUse) && ((_c4 = global6.ShadyDOM) === null || _c4 === void 0 ? void 0 : _c4.noPatch) === true ? global6.ShadyDOM.wrap : (node) => node;
    ...
    while (lastIndex < s.length) {
      ...
      if (regex === textEndRegex2) {
        ...
        if (match[ENTIRE_MATCH2] === ">") {
          regex = rawTextEndRegex !== null && rawTextEndRegex !== void 0 ? rawTextEndRegex : textEndRegex2;
          attrNameEndIndex = -1;
...
var Template2 = class _Template {
  constructor({ strings, ["_$litType$"]: type }, options) {
    ...
    debugLogEvent4 === null || debugLogEvent4 === void 0 ? void 0 : debugLogEvent4({
      kind: "template prep",
      template: this,
      clonableTemplate: this.el,
      parts: this.parts,
...
var ChildPart2 = class _ChildPart {
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive2(value)) {
      ...
      if (DEV_MODE4 && ((_a6 = this.options) === null || _a6 === void 0 ? void 0 : _a6.host) === value) {
        this._commitText(`[probable mistake: rendered a template's host in itself (commonly caused by writing \${this} in a template]`);
        console.warn(`Attempted to render the template host`, value, `inside itself. This is almost always a mistake, and in dev mode `, `we render some warning text. In production however, we'll `, `render it, which will usually result in an error, and sometimes `, `in the element disappearing from the DOM.`);
        return;
      }
...
var AttributePart2 = class {
  ...
  _commitValue(value) {
    if (value === nothing2) {
      ...
      wrap2(this.element).setAttribute(this.name, value !== null && value !== void 0 ? value : "");
    }
  }
};
...
var emptyStringForBooleanAttribute4 = trustedTypes4 ? trustedTypes4.emptyScript : "";
var BooleanAttributePart2 = class extends AttributePart2 {
  ...
  _commitValue(value) {
    ...
    if (value && value !== nothing2) {
      wrap2(this.element).setAttribute(this.name, emptyStringForBooleanAttribute4);
    } else {
      wrap2(this.element).removeAttribute(this.name);
    }
  }
...
var EventPart2 = class extends AttributePart2 {
  ...
  _$setValue(newListener, directiveParent = this) {
    var _a6;
    newListener = (_a6 = resolveDirective2(this, newListener, directiveParent, 0)) !== null && _a6 !== void 0 ? _a6 : nothing2;
...
var _$LH = {
  // Used in lit-ssr
  _boundAttributeSuffix: boundAttributeSuffix2,
  _marker: marker2,
  _markerMatch: markerMatch2,
  _HTML_RESULT: HTML_RESULT2,
  _getTemplateHtml: getTemplateHtml2,
  // Used in tests and private-ssr-support
  _TemplateInstance: TemplateInstance2,
  _isIterable: isIterable2,
  _resolveDirective: resolveDirective2,
  _ChildPart: ChildPart2,
  _AttributePart: AttributePart2,
  _BooleanAttributePart: BooleanAttributePart2,
  _EventPart: EventPart2,
  _PropertyPart: PropertyPart2,
  _ElementPart: ElementPart2
};
var polyfillSupport4 = DEV_MODE4 ? global6.litHtmlPolyfillSupportDevMode : global6.litHtmlPolyfillSupport;
polyfillSupport4 === null || polyfillSupport4 === void 0 ? void 0 : polyfillSupport4(Template2, ChildPart2);
((_d4 = global6.litHtmlVersions) !== null && _d4 !== void 0 ? _d4 : global6.litHtmlVersions = []).push("2.8.0");
...
var render2 = (value, container, options) => {
  ...
  if (part === void 0) {
    const endNode = (_b6 = options === null || options === void 0 ? void 0 : options.renderBefore) !== null && _b6 !== void 0 ? _b6 : null;
    partOwnerNode["_$litPart$"] = part = new ChildPart2(container.insertBefore(createMarker2(), endNode), endNode, void 0, options !== null && options !== void 0 ? options : {});
  }
  part._$setValue(value);
  debugLogEvent4 === null || debugLogEvent4 === void 0 ? void 0 : debugLogEvent4({
    kind: "end render",
...
var _b5;
var _c5;
var UpdatingElement = ReactiveElement2;
var DEV_MODE5 = true;
var issueWarning5;
if (DEV_MODE5) {
...
var LitElement = class extends ReactiveElement2 {
  ...
  createRenderRoot() {
    ...
    (_a6 = (_b6 = this.renderOptions).renderBefore) !== null && _a6 !== void 0 ? _a6 : _b6.renderBefore = renderRoot.firstChild;
    return renderRoot;
  }
  /**
   * Updates the element. This method reflects property values to attributes
...
(_b5 = globalThis.litElementHydrateSupport) === null || _b5 === void 0 ? void 0 : _b5.call(globalThis, { LitElement });
var polyfillSupport5 = DEV_MODE5 ? globalThis.litElementPolyfillSupportDevMode : globalThis.litElementPolyfillSupport;
polyfillSupport5 === null || polyfillSupport5 === void 0 ? void 0 : polyfillSupport5({ LitElement });
if (DEV_MODE5) {
  LitElement["finalize"] = function() {
    const finalized3 = ReactiveElement2.finalize.call(this);
    if (!finalized3) {
      return false;
    }
    const warnRemovedOrRenamed = (obj, name, renamed = false) => {
      if (obj.hasOwnProperty(name)) {
        ...
        issueWarning5(renamed ? "renamed-api" : "removed-api", `\`${name}\` is implemented on class ${ctorName}. It has been ${renamed ? "renamed" : "removed"} in this version of LitElement.`);
      }
    };
...
((_c5 = globalThis.litElementVersions) !== null && _c5 !== void 0 ? _c5 : globalThis.litElementVersions = []).push("3.3.3");
...
var isServer = NODE_MODE7;
export {
  CSSResult2 as CSSResult,
  LitElement,
  ReactiveElement2 as ReactiveElement,
  UpdatingElement,
  _$LE,
  _$LH,
  adoptStyles2 as adoptStyles,
  css,
  defaultConverter2 as defaultConverter,
  getCompatibleStyle2 as getCompatibleStyle,
  html2 as html,
  isServer,
  ...
  nothing2 as nothing,
  render2 as render,
  supportsAdoptingStyleSheets2 as supportsAdoptingStyleSheets,
  svg2 as svg,
  unsafeCSS2 as unsafeCSS
};
